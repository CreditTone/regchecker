...
@Slf4j
@Component
public class YueMeiSpider implements PapaSpider {
...
//		System.out.println(new YueMeiSpider().checkTelephone("18515290717"));
//		System.out.println(new YueMeiSpider().checkTelephone("18210538513"));
//	}
