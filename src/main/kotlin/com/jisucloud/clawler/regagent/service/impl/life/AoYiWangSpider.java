...
@Slf4j
@UsePapaSpider
public class AoYiWangSpider implements PapaSpider {
	...
	public static void main(String[] args) throws InterruptedException {
		System.out.println(new AoYiWangSpider().checkTelephone("18210014444"));
		System.out.println(new AoYiWangSpider().checkTelephone("18210538513"));
	}
