...
@Slf4j
@Component
public class HeZhogEDaiSpider implements PapaSpider {
...
//		System.out.println(new HeZhogEDaiSpider().checkTelephone("15985268901"));
//		System.out.println(new HeZhogEDaiSpider().checkTelephone("18210538513"));
//	}
