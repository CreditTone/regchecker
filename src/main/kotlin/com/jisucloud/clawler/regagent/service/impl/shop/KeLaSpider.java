...
@Slf4j
@UsePapaSpider
public class KeLaSpider implements PapaSpider {
...
//		System.out.println(new KeLaSpider().checkTelephone("18210538511"));
//		System.out.println(new KeLaSpider().checkTelephone("18210538513"));
//	}
