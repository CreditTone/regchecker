...
@Slf4j
@UsePapaSpider
public class KuaiZiXunSpider implements PapaSpider {
	...
	public static void main(String[] args) throws InterruptedException {
		System.out.println(new KuaiZiXunSpider().checkTelephone("18210538000"));
		System.out.println(new KuaiZiXunSpider().checkTelephone("18210538513"));
	}
