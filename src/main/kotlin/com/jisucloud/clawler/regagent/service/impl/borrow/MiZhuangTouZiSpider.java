...
@Slf4j
@UsePapaSpider
public class MiZhuangTouZiSpider implements PapaSpider {
...
//		System.out.println(new MiZhuangTouZiSpider().checkTelephone("15985268904"));
//		System.out.println(new MiZhuangTouZiSpider().checkTelephone("18210538513"));
//	}
