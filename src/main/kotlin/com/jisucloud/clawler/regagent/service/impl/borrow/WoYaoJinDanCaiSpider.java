...
@Slf4j
@Component
public class WoYaoJinDanCaiSpider implements PapaSpider {
	...
	public static void main(String[] args) throws InterruptedException {
		System.out.println(new WoYaoJinDanCaiSpider().checkTelephone("15985268904"));
		System.out.println(new WoYaoJinDanCaiSpider().checkTelephone("18210538513"));
	}
