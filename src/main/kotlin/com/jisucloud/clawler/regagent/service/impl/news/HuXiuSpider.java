...
@Slf4j
@UsePapaSpider
public class HuXiuSpider implements PapaSpider {
	...
	public boolean checkTelephone(String account) {
		try {
			String url = "https://m.huxiu.com/user_action/resetCaptcha";
			...
			Request request = new Request.Builder().url(url)
					...
					.addHeader("Referer", "https://m.huxiu.com/user/reset_password")
					.post(formBody)
					.build();
