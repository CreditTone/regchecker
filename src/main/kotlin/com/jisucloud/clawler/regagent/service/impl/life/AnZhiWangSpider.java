...
@Slf4j
@Component
public class AnZhiWangSpider implements PapaSpider {
	...
	@Override
	public String[] tags() {
		return new String[] {"系统工具"};
	}

//	public static void main(String[] args) throws InterruptedException {
//		System.out.println(new AnZhiWangSpider().checkTelephone("18210014444"));
//		System.out.println(new AnZhiWangSpider().checkTelephone("18210538513"));
//	}
