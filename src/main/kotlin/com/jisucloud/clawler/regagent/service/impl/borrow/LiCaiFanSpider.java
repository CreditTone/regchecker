...
@Slf4j
@Component
public class LiCaiFanSpider implements PapaSpider {
...
//		System.out.println(new LiCaiFanSpider().checkTelephone("15985268904"));
//		System.out.println(new LiCaiFanSpider().checkTelephone("18210538513"));
//	}
