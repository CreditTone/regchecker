...
@Slf4j
@Component
public class GuangXinDaiSpider implements PapaSpider {
...
//		System.out.println(new GuangXinDaiSpider().checkTelephone("15985268904"));
//		System.out.println(new GuangXinDaiSpider().checkTelephone("18210538513"));
//	}
