...
@Slf4j
@Component
public class LingYongDaiSpider implements PapaSpider {
...
//		System.out.println(new LingYongDaiSpider().checkTelephone("15985268904"));
//		System.out.println(new LingYongDaiSpider().checkTelephone("18210538513"));
//	}
