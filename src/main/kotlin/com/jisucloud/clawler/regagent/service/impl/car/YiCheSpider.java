...
@Slf4j
@Component
public class YiCheSpider implements PapaSpider {
...
//		System.out.println(new YiCheSpider().checkTelephone("18611216720"));
//		System.out.println(new YiCheSpider().checkTelephone("18210538513"));
//	}
