...
@Slf4j
@Component
public class BingChuanSpider implements PapaSpider {
...
//		System.out.println(new BingChuanSpider().checkTelephone("13910252045"));
//		System.out.println(new BingChuanSpider().checkTelephone("18210538513"));
//	}
