...
@Slf4j
@UsePapaSpider
public class AoYouSpider implements PapaSpider {
...
//		System.out.println(new AoYouSpider().checkTelephone("13910252045"));
//		System.out.println(new AoYouSpider().checkTelephone("18210538513"));
//	}
