...
@Slf4j
@Component
public class XunLeiSpider implements PapaSpider {
...
//		System.out.println(new XunLeiSpider().checkTelephone("18611216720"));
//		System.out.println(new XunLeiSpider().checkTelephone("18210538513"));
//	}
