...
@Slf4j
@Component
public class XinXinDaiSpider implements PapaSpider {
...
//		System.out.println(new XinXinDaiSpider().checkTelephone("15985268904"));
//		System.out.println(new XinXinDaiSpider().checkTelephone("18210538513"));
//	}
