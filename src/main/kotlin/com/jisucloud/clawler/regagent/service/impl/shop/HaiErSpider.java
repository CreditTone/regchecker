...
@Slf4j
@UsePapaSpider
public class HaiErSpider implements PapaSpider {
...
//		System.out.println(new HaiErSpider().checkTelephone("18515290717"));
//		System.out.println(new HaiErSpider().checkTelephone("18210538513"));
//	}
