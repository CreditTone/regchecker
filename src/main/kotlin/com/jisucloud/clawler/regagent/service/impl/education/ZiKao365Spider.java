...
@Slf4j
@UsePapaSpider
public class ZiKao365Spider implements PapaSpider {
...
//		System.out.println(new ZiKao365Spider().checkTelephone("15010645316"));
//		System.out.println(new ZiKao365Spider().checkTelephone("18210538513"));
//	}
