...
@Slf4j
@Component
public class XinShengDaiSpider implements PapaSpider {
...
//		System.out.println(new XinShengDaiSpider().checkTelephone("15985268904"));
//		System.out.println(new XinShengDaiSpider().checkTelephone("18210538513"));
//	}
