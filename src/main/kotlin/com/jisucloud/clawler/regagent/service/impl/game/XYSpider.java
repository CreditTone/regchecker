...
@Slf4j
@Component
public class XYSpider implements PapaSpider {
...
//		System.out.println(new XYSpider().checkTelephone("18720982607"));
//		System.out.println(new XYSpider().checkTelephone("18210538513"));
//	}
