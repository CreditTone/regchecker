...
@Slf4j
@UsePapaSpider
public class ZhangFuTongSpider implements PapaSpider {
	...
	@Override
	public String[] tags() {
		return new String[] {"工具" , "违章查询"};
	}

//	public static void main(String[] args) throws InterruptedException {
//		System.out.println(new ZhangFuTongSpider().checkTelephone("18210538513"));
//		System.out.println(new ZhangFuTongSpider().checkTelephone("13925306960"));
//	}
